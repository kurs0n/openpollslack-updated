...
export const btn_vote10 = (app,mutexes,votesCol,getInfos,buildInfosBlocks,buildMenu)=>{
    app.action('btn_vote10', async ({ action, ack, body, context }) => {
        await ack();
          ...
          try {
            ...
            if (removeVote) {
              ...
              await app.client.chat.postEphemeral({
                ...
                user: body.user.id,
                attachments: [],
                text: `You've vote for 10 points on option ${question}`,
            });
            }
